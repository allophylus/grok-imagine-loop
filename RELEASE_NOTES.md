...
## v1.5.4
- **Fix:** **Multi-Language Support**: Fixed issues where the extension failed on non-English interfaces (e.g., Portuguese, German, French, Spanish, Italian, Japanese, Chinese). Now supports broader keywords for "Make video", "Type to customize", "Redo", etc.
